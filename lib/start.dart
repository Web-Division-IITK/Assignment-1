      ...
      body: SingleChildScrollView(
        child: Container(
          child: Column(
            children: <Widget>[
              Container(
                child: Image(image: AssetImage("assets/images/a.jpg"),fit:BoxFit.contain),
              ...
              RichText( 
                ...
                children: <TextSpan>[
                  TextSpan(
                    text: 'Noted',style:TextStyle(fontSize: 30.0,color: Colors.orange,
                  ...
                  Text('remember everything',style: TextStyle(color: Colors.red,fontSize: 20.0),),
